            ...
            <div class="mx-auto w-full max-w-[550px]">
                <form action="" method="">
                    {{-- <div class="mb-5">
                        ...
                        <input type="text" name="name" id="name" placeholder="Full Name" value="{{ (Auth::user()->name) }}"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="email" name="email" value="{{ (Auth::user()->email) }}" id="email" placeholder="example@domain.com"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div> --}}
